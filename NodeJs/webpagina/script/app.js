...
let htmlStopButton, htmlEndScoreMenuButton, htmlLeaderboardReturnButton, htmlLeaderboardButton, htmlLeaderBoardPage, htmlLeaderBoardList, htmlEndGameName, htmlEndGameScore, htmlHelpButton, htmlHelpReturnButton, htmlLeaderboardButtonEntry;
...
const listenToInputs = function () {
  ...
  htmlLeaderboardButton.addEventListener("click", function () {
    ...
    window.location.href = "/leaderboard" + currentParams;
    // window.location.href = "/leaderboard";
  });
  htmlLeaderboardButtonEntry.addEventListener("click", function () {
    console.log("Leaderboard button clicked");
    window.location.href = "/leaderboard";
  });
...
const init = function () {
  ...
  if (htmlLeaderBoardPage) {
    ...
    htmlLeaderboardButtonEntry = document.querySelector(".js-leaderboard-btnentry");
